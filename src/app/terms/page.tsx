...
export default function TermsOfService() {
  return (
    <div className="max-w-[95%] mx-auto mt-25 mb-5 p-8 bg-[var(--bg)] text-[#e0e0e0] rounded-[12px] shadow-[0_4px_16px_rgba(0,0,0,0.7)] leading-[1.75]">
      ...
      <h2 className="text-[1.75rem] my-8 text-white border-l-4 border-[var(--qp1)] pl-3 font-bold">1. What the Service Is</h2>
      <p className="mb-5">
      ...
      <h2 className="text-[1.75rem] my-8 text-white border-l-4 border-[var(--qp1)] pl-3 font-bold">2. Eligibility</h2>
      <p className="mb-5">
      ...
      <h2 className="text-[1.75rem] my-8 text-white border-l-4 border-[var(--qp1)] pl-3 font-bold">3. Accounts & Security</h2>
      <p className="mb-5">
      ...
      <h2 className="text-[1.75rem] my-8 text-white border-l-4 border-[var(--qp1)] pl-3 font-bold">4. Intellectual Property & License</h2>
      <p className="mb-5">
      ...
      <h2 className="text-[1.75rem] my-8 text-white border-l-4 border-[var(--qp1)] pl-3 font-bold">5. Acceptable Use</h2>
      ...
      <h2 className="text-[1.75rem] my-8 text-white border-l-4 border-[var(--qp1)] pl-3 font-bold">6. Third-Party Services</h2>
      <p className="mb-5">
      ...
      <h2 className="text-[1.75rem] my-8 text-white border-l-4 border-[var(--qp1)] pl-3 font-bold">7. Availability, Changes, and Beta Features</h2>
      <p className="mb-5">
      ...
      <h2 className="text-[1.75rem] my-8 text-white border-l-4 border-[var(--qp1)] pl-3 font-bold">8. No Professional or Investment Advice</h2>
      <p className="mb-5">
      ...
      <h2 className="text-[1.75rem] my-8 text-white border-l-4 border-[var(--qp1)] pl-3 font-bold">9. Warranty Disclaimer</h2>
      <p className="mb-5">
      ...
      <h2 className="text-[1.75rem] my-8 text-white border-l-4 border-[var(--qp1)] pl-3 font-bold">10. Limitation of Liability</h2>
      <p className="mb-5">
      ...
      <h2 className="text-[1.75rem] my-8 text-white border-l-4 border-[var(--qp1)] pl-3 font-bold">11. Feedback</h2>
      <p className="mb-5">
      ...
      <h2 className="text-[1.75rem] my-8 text-white border-l-4 border-[var(--qp1)] pl-3 font-bold">12. Termination</h2>
      <p className="mb-5">
      ...
      <h2 className="text-[1.75rem] my-8 text-white border-l-4 border-[var(--qp1)] pl-3 font-bold">13. Changes to These Terms</h2>
      <p className="mb-5">
      ...
      <h2 className="text-[1.75rem] my-8 text-white border-l-4 border-[var(--qp1)] pl-3 font-bold">14. Contact</h2>
